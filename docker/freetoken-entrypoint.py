...
The web container talks to this process for lifecycle operations.  Keeping
the supervisor beside the GPU runtime means the web image never needs the
FreeToken package, CUDA, or access to the Docker socket.
"""
